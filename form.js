...
$(document).ready(function() {
  $("#formcontentslide7").click(function() {
    var buttonslide7 = document.getElementById("buttonslide7");
    if($("input[id='checkboxslide8']:checked").val() || $("input[id='checkbox-norareissues']:checked").val() || $("input[id='checkbox-otherlead']:checked").val()){
